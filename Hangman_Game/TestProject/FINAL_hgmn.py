...
def level5(root3):
    ...
    photo3 = PhotoImage(file='C:\\Users\\{Utkarsh}\\Desktop\\Hangman_Game\\TestProject\\IMG6.png')
...
def level4(root2):
    ...
    canvas = Canvas(width = 350, height =350 ,bg = 'white')
    canvas.place(x = 10, y = 10)
    photo2 = PhotoImage(file='C:\\Users\\{Utkarsh}\\Desktop\\Hangman_Game\\TestProject\\IMG5.png')
...
def level3(root1):
    ...
    canvas = Canvas(width = 350, height =350 ,bg = 'white')
    canvas.place(x = 10, y = 10)
    photo1 = PhotoImage(file='C:\\Users\\{Utkarsh}\\Desktop\\Hangman_Game\\TestProject\\IMG4.png')
...
def level2():
    ...
    canvas = Canvas(width = 350, height =350 ,bg = 'white')
    canvas.place(x = 10, y = 10)
    photo = PhotoImage(file='C:\\Users\\{Utkarsh}\\Desktop\\Hangman_Game\\TestProject\\IMG3.png')
...
canvas = Canvas(width = 350, height =350 ,bg = 'white')
canvas.place(x = 10, y = 10)
photo = PhotoImage(file='C:\\Users\\{Utkarsh}\\Desktop\\Hangman_Game\\TestProject\\IMG1.png')
canvas.create_image(20,20,image=photo,anchor=NW)
